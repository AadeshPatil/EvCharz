...
import com.project.wheels_on_demand.Model.BookingModel;
import com.project.wheels_on_demand.Model.HostSideBooking;
...
public class PaymentActivity extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        electricity_consumption.setText(unit_con + " Per Hour");
        use_duration.setText(formatDuration(duration));
    ...
    public void startPayment(String price) {
        ...
        try {
            ...
            preFill.put("email", "paradhipriya02@gmail.com");
            preFill.put("contact", "+919145040590");
